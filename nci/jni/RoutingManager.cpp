...
bool RoutingManager::initialize(nfc_jni_native_data* native) {
  ...
  if (mDefaultTechABFRoute != 0) { // MODIFIED by zhangjie, 2020-12-14,BUG-10277814
...
void RoutingManager::enableRoutingToHost() {
  ...
  tNFA_STATUS nfaStat = NFA_STATUS_FAILED; // MODIFIED by zhangjie, 2020-12-14,BUG-10277814
